      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _buildArenaOption(context, title: "GRAND TOURNOI", subtitle: "5 joueurs - Battle Royale", icon: FontAwesomeIcons.crown, color: Colors.orangeAccent, onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const TournamentLobbyScreen()))),
          ],
        ),
      ),
    );
